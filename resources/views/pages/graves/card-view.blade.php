                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-footer text-center"> 
                            ...
                            <a href="{{ asset('grave-delete/'.$item["GraveID"]) }}"
                                class="btn btn-danger m-1">Delete</a>
                            <a href="{{ asset('grave-map?graveId='.$item["GraveID"]) }}" class="btn btn-danger m-1"> <i
                                    class="fa fa-map-marker" aria-hidden="true"></i> Map</a>
                        </div>
                    </div>
                </div>
                @endforeach
