    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('purchase-update/'.$purchase['PurchaseID']) }}" method="post" class="m-4">
                    @csrf
                    <div class=" ">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Purchase ID</label>
                            <input type="text" class="form-control" id="PurchaseID" name="PurchaseID"
                                placeholder="Purchase ID" value="{{ $purchase['PurchaseID'] }}" readonly="">
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select id="Owner" class="form-control" name="Owner#">
                                        ...
                                        <option value="{{ $item['Owner#'] }}" {{ $item['Owner#'] == $purchase['Owner#'] ? 'selected' : ''  }} >{{ $item['Own_Fname'].' '.$item['Own_Mname'].' '.$item['Own_Lname'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $purchase['GraveID'] }}" id="GraveID" name="GraveID"
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime" class="form-control" value="{{ $purchase['Purchase_Date'] }}" id="Purchase_Date" name="Purchase_Date"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control"
                                        id="Purchase_Amt" placeholder="Purchase Amt" value="{{ $purchase['Purchase_Amt'] }}"  name="Purchase_Amt">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Reference#</label>
                            <input type="text" class="form-control" id="Reference" name="Reference#" placeholder="Reference#"  value="{{ $purchase['Reference#'] }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="Purchase_Notes" name="Purchase_Notes" placeholder="Purchase Notes"
                                rows="2">{{ $purchase['Purchase_Notes'] }}</textarea>
                        </div>
                    </div>
